document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateSpeedometer() {
        ...
        // Needle rotation: -120deg to 110deg (consistent with index.html)
        const rotation = -120 + (progress * 2.3);
        ...
        // Text value
        let start = parseInt(valueDisplay.textContent);
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(
                    (position) => {
                        ...
                        // For demo purposes, we show coords. Ideally reverse geocode here.
                        locInput.value = `Lat: ${latitude.toFixed(5)}, Long: ${longitude.toFixed(5)}`;
                        locBtn.innerHTML = '<i class="fa-solid fa-location-crosshairs"></i> Detected';
                        locBtn.style.color = '#28a745';
                    },
                    (error) => {
                        locInput.placeholder = "Error detecting location";
                        locBtn.innerHTML = '<i class="fa-solid fa-triangle-exclamation"></i> Retry';
                        console.error(error);
                    }
                );
            } else {
